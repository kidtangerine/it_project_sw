...
$document->addStyleSheet(JUri::root() . 'administrator/components/com_itproject/assets/css/itproject.css');
$document->addStyleSheet(JUri::root() . 'media/com_itproject/css/list.css');

$user      = JFactory::getUser();
$userId    = $user->get('id');
$listOrder = $this->state->get('list.ordering');
$listDirn  = $this->state->get('list.direction');
$canOrder  = $user->authorise('core.edit.state', 'com_itproject');
$saveOrder = $listOrder == 'a.`ordering`';

if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_itproject&task=projects.saveOrderAjax&tmpl=component';
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="projectList">
				...
				<?php foreach ($this->items as $i => $item) :
					...
					$canCreate  = $user->authorise('core.create', 'com_itproject');
					$canEdit    = $user->authorise('core.edit', 'com_itproject');
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_itproject&task=project.edit&id='.(int) $item->id); ?>">
